  ...
  <section>
    ...
    <el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange"
      ...
      <el-table-column prop="avatar" label="头像" width="120">
        <template scope="scope">
          <a href="http://localhost:8080/#/doctor">
      ...
      <el-form :model="editForm" label-width="80px" :rules="editFormRules" ref="editForm">
        ...
        <el-form-item label="用户头像" prop="avatar">
          <img :src="editForm.avatar" style="border-radius:50%; " width="100" height="100"
               alt="用户头像">
          <el-upload
              action="http://localhost:8000/clinic/doctorInformation/upload"
              ref="edit"
        ...
        <el-form-item label="所在科室" prop="did">
          <el-select v-model="editForm.did" placeholder="请选择所在科室">
            <el-option
                v-for="item in departmentList"
                :key="item.id"
                :label="item.name"
        ...
        <el-form-item label="挂号级别" prop="registereId">
          <el-select v-model="editForm.registereId" placeholder="请选择挂号级别">
            <el-option
                v-for="item in dutyTimeLIst"
                :key="item.id"
                :label="item.value"
        ...
        <el-form-item label="工资" prop="salary">
          <el-input type="text" v-model="editForm.salary" disabled style="width: 200px"></el-input>
        </el-form-item>
    ...
    <el-dialog title="上传表单" v-model="uploadServerVisibleUser" :close-on-click-modal="false">
      ...
      <el-upload
          ...
          drag
          :limit="1"
          action="http://localhost:8000/clinic/doctorInformation/uploadToServer"
          :file-list="fileList"
    ...
    <el-dialog title="新增" v-model="addFormVisible" :close-on-click-modal="false">
      ...
      <el-form :model="addForm" label-width="80px" :rules="addFormRules" ref="addForm">
        ...
        <el-form-item label="所在科室" prop="did">
          <el-select v-model="addForm.did" placeholder="请选择所在科室">
            <el-option
                v-for="item in departmentList"
                :key="item.id"
                :label="item.name"
        ...
        <el-form-item label="值班时间" prop="did">
          <el-select v-model="addForm.duty" placeholder="请选择值班时间">
            <el-option
                v-for="item in allDuty"
                :key="item.id"
                :label="item.value"
                :value="item.id"></el-option>
          </el-select>
        ...
        <el-form-item label="挂号级别" prop="registereId">
          <el-select v-model="addForm.registereId" placeholder="请选择挂号级别">
            <el-option
                v-for="item in dutyTimeLIst"
                :key="item.id"
                :label="item.value"
        ...
        <el-form-item label="薪资" prop="salary">
          <el-input-number v-model="addForm.salary" auto-complete="off" :max="30000" :min="5000"></el-input-number>
        </el-form-item>
...
import {
  addDoctorInformation, analyseFileByDoctorInformation, dataTemplateDownloadByDoctorInformation,
  deleteByIdsInDoctor,
  editDoctorInformation, exportDataByDoctorInformation, findAllByAllDuty,
  findAllDoctor,
