<template>
  <section>
    ...
    <el-col :span="24" class="toolbar">
      <el-button type="danger" @click="batchRemove" :disabled="this.sels.length===0">批量撤销</el-button>
...
import {
  ...
  analyseFileByDoctorInformation,
  cancelAppointment,
  dataTemplateDownloadByDoctorInformation,
  exportDataByDoctorInformation,
  findAllByAllDuty,
  findDepartmentCoding,
  findDutyTimeCoding,
  findReserveNotViewed
} from '../../api/api';
...
export default {
  ...
  methods: {
    ...
    getUsers() {
      ...
      findReserveNotViewed(para,configs).then((res) => {
